...
/*!***************************!*\
  !*** ./heatmapControl.ts ***!
  \***************************/
/*! exports provided: default, HeatmapCtrl, MetricsPanelCtrl */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HeatmapCtrl", function() { return HeatmapCtrl; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MetricsPanelCtrl", function() { return HeatmapCtrl; });
...
/* harmony import */ var grafana_app_core_time_series2__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! grafana/app/core/time_series2 */ "grafana/app/core/time_series2");
/* harmony import */ var grafana_app_core_time_series2__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(grafana_app_core_time_series2__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var grafana_app_core_utils_kbn__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! grafana/app/core/utils/kbn */ "grafana/app/core/utils/kbn");
/* harmony import */ var grafana_app_core_utils_kbn__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(grafana_app_core_utils_kbn__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _properties__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./properties */ "./properties.ts");
...
function (_super) {
  ...
  function HeatmapCtrl($scope, $injector, elem) {
    ...
    lodash_defaultsDeep__WEBPACK_IMPORTED_MODULE_2___default()(_this.panel, panelDefaults);
    _this.canvas = _this.elem.find('.canvas')[0];
    ...
    _this.events.on('data-error', _this.handleError.bind(_this));
  ...
  HeatmapCtrl.prototype.initializePanel = function () {};

  HeatmapCtrl.prototype.handleError = function (err) {
    console.error(err);
  };

  HeatmapCtrl.prototype.onInitEditMode = function () {
    this.addEditorTab('Heatmap', _properties__WEBPACK_IMPORTED_MODULE_6__["heatmapEditor"], 2);
    this.addEditorTab('Display', _properties__WEBPACK_IMPORTED_MODULE_6__["displayEditor"], 3);
  };
  ...
  HeatmapCtrl.prototype.onDataReceived = function (dataList) {
    ...
    if (undefined !== dataList) {
      this.series = dataList.map(function (seriesData) {
        return _this.seriesHandler(seriesData);
      });
  ...
  HeatmapCtrl.prototype.getGroupKeys = function () {
  ...
  HeatmapCtrl.prototype.d3plusDataProcessor = function (dataArray) {
    var resultArray = [];
    ...
    if (!hasGroups) {
      ...
      for (var groupIndex = 0; groupIndex < this.panel.treeMap.groups.length; groupIndex++) {
        groupArray.push({
          ...
          regex: grafana_app_core_utils_kbn__WEBPACK_IMPORTED_MODULE_5___default.a.stringToJsRegex(this.panel.treeMap.groups[groupIndex].value)
        });
      }

      for (var dataIndex = 0; dataIndex < dataArray.length; dataIndex++) {
        var newDataItem = Object.assign({}, dataArray[dataIndex]); // only add the stats if we arent using granular timeblock data
  ...
  HeatmapCtrl.prototype.seriesHandler = function (seriesData) {
    var series = new grafana_app_core_time_series2__WEBPACK_IMPORTED_MODULE_4___default.a({
  ...
  HeatmapCtrl.prototype.addSeriesOverride = function (override) {
    this.panel.seriesOverrides.push(override || {});
  };

  HeatmapCtrl.prototype.addTreeMapGroup = function (group) {
    this.panel.treeMap.groups.push(group || {});
  };

  HeatmapCtrl.prototype.removeSeriesOverride = function (override) {
    this.panel.seriesOverrides = lodash__WEBPACK_IMPORTED_MODULE_7___default.a.without(this.panel.seriesOverrides, override);
    this.render();
  };

  HeatmapCtrl.prototype.removeTreeMapGroup = function (group) {
    this.panel.treeMap.groups = lodash__WEBPACK_IMPORTED_MODULE_7___default.a.without(this.panel.treeMap.groups, group);
    this.render();
  };

  HeatmapCtrl.prototype.updateThresholds = function () {
    // var thresholdCount = this.panel.thresholds.length;
    // var colorCount = this.panel.colors.length;
    this.refresh();
  };

  HeatmapCtrl.prototype.changeColor = function (colorIndex, color) {
    this.panel.colors[colorIndex] = color;
  };

  HeatmapCtrl.prototype.removeColor = function (colorIndex) {
    this.panel.colors.splice(colorIndex, 1);
  };

  HeatmapCtrl.prototype.addColor = function () {
    this.panel.colors.push('rgba(255, 255, 255, 1)');
  };

  HeatmapCtrl.prototype.getGradientForValue = function (data, value) {
    ...
    var xPercent = valueDistanceFromMin / absoluteDistance; // Get the smaller number to clamp at 0.99 max

    xPercent = Math.min(0.99, xPercent); // Get the larger number to clamp at 0.01 min

    xPercent = Math.max(0.01, xPercent);
    return getColorByXPercentage(this.canvas, xPercent);
  };

  HeatmapCtrl.prototype.applyOverrides = function (seriesItemAlias) {
    var seriesItem = {},
        colorData = {};
    var overrides = {};
  ...
  HeatmapCtrl.prototype.invertColorOrder = function () {
    this.panel.colors.reverse();
    this.refresh();
  };

  HeatmapCtrl.prototype.addTreeMapId = function () {
    this.panel.treeMap.ids.push('');
    this.refresh();
  };

  HeatmapCtrl.prototype.removeTreeMapId = function (pos) {
    this.panel.treeMap.ids.splice(pos, 1);
    this.refresh();
  };

  HeatmapCtrl.prototype.changeTreeMapId = function (idString, pos) {
  ...
  HeatmapCtrl.prototype.link = function (scope, elem, attrs, ctrl) {
    ...
    var visFormat = {
      text: function text(_text, opts) {
        if (opts.key === 'timestamp') {
          var timestamp = moment__WEBPACK_IMPORTED_MODULE_8___default()(Number(_text));
    ...
    */
    ...
    function updateChart(data) {
      d3__WEBPACK_IMPORTED_MODULE_3__["select"]('#' + ctrl.containerDivId).selectAll('*').remove(); // Make sure the necessary IDs are added
      ...
      aggs.avg = 'mean';
      aggs.min = 'min';
      aggs.max = 'max'; // TODO: draw the graph
    }
...
/* harmony default export */ __webpack_exports__["default"] = (HeatmapCtrl);
...
/* harmony import */ var _heatmapControl__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./heatmapControl */ "./heatmapControl.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "PanelCtrl", function() { return _heatmapControl__WEBPACK_IMPORTED_MODULE_1__["HeatmapCtrl"]; });

/* harmony import */ var _properties__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./properties */ "./properties.ts");



Object(grafana_app_plugins_sdk__WEBPACK_IMPORTED_MODULE_0__["loadPluginCss"])({
  dark: _properties__WEBPACK_IMPORTED_MODULE_2__["darkCss"],
  light: _properties__WEBPACK_IMPORTED_MODULE_2__["lightCss"]
...
/*!***********************!*\
  !*** ./properties.ts ***!
  \***********************/
/*! exports provided: pluginName, heatmapEditor, displayEditor, lightCss, darkCss */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "pluginName", function() { return pluginName; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "heatmapEditor", function() { return heatmapEditor; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "displayEditor", function() { return displayEditor; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "lightCss", function() { return lightCss; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "darkCss", function() { return darkCss; });
var pluginName = 'savantly-heatmap-panel';
var heatmapEditor = "public/plugins/" + pluginName + "/partials/heatmapEditor.html",
