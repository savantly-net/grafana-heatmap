...
export interface HeatmapLegendEditorLegendOptions extends LegendOptions {
    stats?: string[];
    decimals?: number;
    sortBy?: string;
    sortDesc?: boolean;
...
interface HeatmapLegendEditorProps {
    options: HeatmapLegendEditorLegendOptions;
    onChange: (options: HeatmapLegendEditorLegendOptions) => void;
}

export const HeatmapLegendEditor: React.FunctionComponent<HeatmapLegendEditorProps> = props => {
